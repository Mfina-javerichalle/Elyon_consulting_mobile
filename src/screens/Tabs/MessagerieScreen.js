  ...
  const renderDossier = ({ item }) => (
    ...
    >
      ...
      <View style={styles.cardContent}>
        ...
        <View style={[styles.badge, { backgroundColor: COLORS.status[item.statut] + '22' }]}>
...
const styles = StyleSheet.create({
  ...
  dossierName: { fontSize: 15, fontWeight: '700', color: COLORS.darkGray, flex: 1, marginRight: 8 },
  date:        { fontSize: 11, color: COLORS.gray },
  pays:        { fontSize: 13, color: COLORS.gray, marginBottom: 6 },
  badge:       { alignSelf: 'flex-start', borderRadius: 20, paddingHorizontal: 10, paddingVertical: 3 },
  badgeText:   { fontSize: 11, fontWeight: '700' },
  arrow:       { color: COLORS.gray, fontSize: 24, marginLeft: 8 },
